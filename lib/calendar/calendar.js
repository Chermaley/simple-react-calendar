  ...
  _createClass(Calendar, [{
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          shownNoticeType = _this$state.shownNoticeType,
          shownTimepicker = _this$state.shownTimepicker;
      ...
      var toggleTimePicker = function toggleTimePicker() {
        _this2.setState({
          shownTimepicker: !shownTimepicker
        });
      };
      ...
      }, "\u0412\u0440\u0435\u043C\u044F"), shownTimepicker && /*#__PURE__*/_react["default"].createElement(_time["default"], {
